...
namespace OuroborosEngine.Managers.EntityManager
{
    public abstract class Entity : IEntity, ICollidable
    {
        ...
        protected Vector2 gravity = new Vector2(0, -3);
        ...
        /// <summary>METHOD: handles the event getting the spacebar input</summary>
        /// <param name="source">the object that is listening</param>
        /// <param name="args">sets the keys being pressed</param>
        ...
        ///////////////////////////////////////  HAD TO BE ADDED FOR WAXEN  /////////////////////////////////////

        // boolean to show if the player will currently be firing
        ...
        // boolean to see if waxballs are colliding
        protected Boolean isColliding;
        public Boolean IsColliding { get { return isColliding; } set { isColliding = value; } }

        // sends the waxball to the scene through the player
        public virtual WaxBall SendWaxBall(Vector2 aim, ContentManager content)
        {
            return null;
        }

        // sends the list of waxball collidables through the player, solved them from being added constantly in the update method
        public virtual List<ICollidable> SendWaxBalls(List<ICollidable> w)
        {
            return null;
        }
    }
