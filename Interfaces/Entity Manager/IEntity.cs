...
namespace OuroborosEngine.Interfaces
{
    public interface IEntity
    {
        ...
        void GetMouseClick(Object source, myEventArgs args);
        ...
        Boolean IsFiring { get; set; }
        WaxBall SendWaxBall(Vector2 aim, ContentManager content);
        List<ICollidable> SendWaxBalls(List<ICollidable> w);
    }
}
